...
$(function(){
    ...
    function createMap(){
        ...
        var point = new BMap.Point(113.414125,23.063644);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"今甲科技有限公司",content:"广州大学城国家数字家庭应用示范产业基地研发园（东区）B区101-104室",point:"113.414125|23.063644",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
    ];
    //创建marker
    function addMarker(){
